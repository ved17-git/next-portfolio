...
<Button radius="lg" className="bg-gradient-to-b from-gray-900 to-gray-600 
 text-white shadow-lg mt-8 font-title text-xl px-8 py-6" onClick={()=>window.open('https://drive.google.com/file/d/1eFUXHnljlvTojtdnIYcnY5KVlE6t-nBL/view?usp=drive_link','_blank')}>
      Resume
</Button>
