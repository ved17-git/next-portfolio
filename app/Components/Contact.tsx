...
function Contact() {
  ...
  return (
    <>
      <h1
        className="text-center mt-[20vh] sm:mt-[15hvh] font-title text-6xl sm:text-3xl mb-10 sm:text-7 "
        id="contact"
      >
        Contact
      </h1>
      ...
      <div className="flex px-[8vh] lg:px-[4vh] gap-10 lg:gap-4 mb-10 w-full md:px-[1vh] sm:flex-col  sm:pt-4 sm:mt-[-4vh]">
        <form className="w-[70%] sm:w-[100%] gap-4 space-y-10 shadow-xl border-[1px] border-zinc-300 p-10 rounded-xl dark:shadow-zinc-800 dark:border-none dark:shadow-md sm:p-3 lg:p-5" ref={form}>
          <div className="flex justify-center items-center ">
            <Avatar src={logo.src} className="w-40 h-40 text-large" />
          </div>

          <div className="w-full flex gap-10 sm:gap-4 lg:gap-6 sm:flex-col">
            <Input
              type="text"
              label="Name"
              placeholder="Name"
    ...
    Globe
      ...
      <div className="flex items-center justify-center gap-2">
        <p>
          <FaLocationDot size={25} className="dark:text-white" />
        </p>
        <p className="font-title text-lg ">Nagpur, Maharashtra</p>
      </div>
      ...
      <div className="relative">
        <Dock
          direction="middle"
          magnification={50}
          className=" dark:shadow-md dark:border-none dark:shadow-zinc-800"
        >
          <DockIcon className="mx-6 sm:mx-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              onClick={() =>
                window.open("https://github.com/ved17-git", "_blank")
              }
              width="128"
          ...
          <DockIcon className="mx-6 sm:mx-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              onClick={() => window.open("mailto:vedp1117@gmail.com", "_blank")}
              width="169.79"
              height="128"
              viewBox="0 0 256 193"
            >
          ...
          <DockIcon className="mx-6 sm:mx-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              onClick={() =>
                window.open("https://leetcode.com/u/vedp1117/", "_blank")
              }
              className="dark:block hidden"
              width="128"
              height="128"
          ...
          <DockIcon className="mx-6 sm:mx-2">
            <svg
              ...
              onClick={() =>
                window.open(
                  "https://www.linkedin.com/in/ved-pandhare-358b45282/",
                  "_blank"
                )
              }
              width="128"
